...
public struct SickleRitual: LocalizableEntity {
    ...
    public let translations: LocaleMap<SickleRitualTranslation>

    public init(id: Id, levels: Levels? = nil, selectOptions: SelectOptions? = nil, maximum: Maximum? = nil, prerequisites: GeneralPrerequisites? = nil, volume: Volume, cost: EnchantmentCost? = nil, property: PropertyDeclaration, apValue: AdventurePointsValue, src: PublicationRefs, translations: LocaleMap<SickleRitualTranslation>) {
        self.id = id
        self.levels = levels
...
public struct SickleRitualTranslation: EntitySubtype {
