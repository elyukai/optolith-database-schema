...
public struct MagicStyleSpecialAbility: LocalizableEntity {
    ...
    public init(id: Id, levels: Levels? = nil, selectOptions: SelectOptions? = nil, skillApplications: SkillApplications? = nil, skillUses: SkillUses? = nil, maximum: Maximum? = nil, advanced: AdvancedSpecialAbilities<AdvancedMagicalSpecialAbilityIdentifier>, prerequisites: GeneralPrerequisites? = nil, apValue: AdventurePointsValue, src: PublicationRefs, translations: LocaleMap<MagicStyleSpecialAbilityTranslation>) {
        self.id = id
        self.levels = levels
