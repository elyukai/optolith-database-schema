...
public struct FamiliarSpecialAbility: LocalizableEntity {
    ...
    public init(id: Id, levels: Levels? = nil, selectOptions: SelectOptions? = nil, maximum: Maximum? = nil, prerequisites: GeneralPrerequisites? = nil, apValue: AdventurePointsValue, src: PublicationRefs, translations: LocaleMap<FamiliarSpecialAbilityTranslation>) {
        self.id = id
        self.levels = levels
