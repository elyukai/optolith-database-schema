...
@Model
public struct MagicStyleSpecialAbility {
    ...
    @MinItems(3)
    @MaxItems(3)
    let advanced: [AdvancedSpecialAbility<AdvancedMagicalSpecialAbilityIdentifierObject>]
    ...
    @Embedded
    struct Translation {  // MagicStyleSpecialAbilityTranslation
