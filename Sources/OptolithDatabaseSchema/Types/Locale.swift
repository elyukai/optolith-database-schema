...
@Model
struct Locale {
    /// Name of the language in its language.
    let name: String

    /// Region in which the language is spoken in its language.
    let region: String
    ...
    let isMissingImplementation: Bool
      ...
      //     "File": Required({ type: VaryBySystem }),
      ...
      //      * - `0`: AP value
      //      */
      //     "{0} Adventure Points": Required({ type: PluralizationCategories }),
      //     /**
      //      * - `0`: AP value
      //      */
      ...
      //     "You are missing {0} Adventure Points to do this.": Required({ type: PluralizationCategories }),
      ...
      //     ", {0} of which are permanent": Required({ type: PluralizationCategories }),
      ...
      //     "(S)": Required({ type: String({ minLength: 1 }) }),
      //     "{0} yards": Required({ type: PluralizationCategories }),
      //     "{0} yd": Required({ type: String({ minLength: 1 }) }),
      //     "{0} miles": Required({ type: PluralizationCategories }),
      ...
      //     "since the {0}. printing": Required({ type: PluralizationCategories }),
      //     "removed in {0}. printing": Required({ type: PluralizationCategories }),
      //   }),
      // }),
