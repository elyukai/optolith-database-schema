...
public enum ContentNode {
    case Child(IncludeIdentifier(ChildNode))
    case Text(IncludeIdentifier(TextNode))
    case Reference(IncludeIdentifier(ReferenceNode))
    case ReferenceList(IncludeIdentifier(ReferenceListNode))
}
...
public enum ReferenceListNodeSource {
    ...
    case Items
    case OptionalRules
    case ImprovementCost(IncludeIdentifier(ReferenceListNodeImprovementCostSource))
}
...
public struct ReferenceListNodeImprovementCostSource {
  ...
  @Relationship(ReferenceListNodeImprovementCostSourceTarget)
  let target: ReferenceListNodeImprovementCostSourceTarget.ID
...
public struct ReferenceNode {
  ...
  /// The nested core rule’s identifier.
  @Relationship(CoreRuleDerivableContentIdentifier)
  let id: CoreRuleDerivableContentIdentifier.ID
  }
