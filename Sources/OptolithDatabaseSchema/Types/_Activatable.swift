...
public enum ApplicableCloseCombatTechniquesRestriction {
    ...
    case ParryingWeapon
    case Race(ApplicableCombatTechniquesRaceRestriction)
    case ExcludeCombatTechniques(ApplicableCombatTechniquesNegativeCombatTechniquesRestriction<CloseCombatTechnique.ID>)
}
...
public enum ApplicableRangedCombatTechniquesRestriction {
    ...
    case Mount
    case Race(ApplicableCombatTechniquesRaceRestriction)
    case ExcludeCombatTechniques(ApplicableCombatTechniquesNegativeCombatTechniquesRestriction<RangedCombatTechnique.ID>)
}
