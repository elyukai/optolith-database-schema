 ...
 */
export type FoolsHatEnchantment = {
  id: Activatable.Id
...
export type FoolsHatEnchantmentTranslation = {
...
export const config: TypeConfig<FoolsHatEnchantment, FoolsHatEnchantment["id"], "FoolsHatEnchantment"> = {
