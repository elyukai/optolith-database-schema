...
export const ResponsiveText = TypeAlias(import.meta.url, {
  name: "ResponsiveText",
  comment:
...
export const ResponsiveTextReplace = TypeAlias(import.meta.url, {
  ...
  type: () =>
    Object({
      full: Required({
        ...
        type: String({ minLength: 1, pattern: /\$1/ }),
      }),
      compressed: Required({
        comment:
...
export const ResponsiveTextOptional = TypeAlias(import.meta.url, {
